...
export function addictionMedicineAccordion(): string {
    ...
    return `
        <div class="fpa-box-wrapper"><div class="guidance-content fpa-box">
            <h3 class="guidance-heading">${DEFINITIONS.addictionMedicine.groupTitle}</h3>
            <p class="fpa-hint">(click below to expand)</p>
            ${items}
        </div></div>`;
}
