...
function buildLateGuidanceFn(tiersMap: Record<string, ReturnType<typeof buildTiers>>): MedDefinition['getLateGuidance'] {
...
export function buildStandardDef(json: any) {
    ...
    if (spec.kind === 'branched') {
        ...
        return {
            ...baseUI,
            handleSubGroupChange: (branchVal: string, show: (id: string) => void, hide: (id: string) => void, clear: (id: string) => void) => {
