...
test.describe('guidance text snapshots', () => {
    ...
    test.skip('abilify_maintena — 3+ doses, 35 days (routine window)', async ({ page }) => {
    ...
    test.skip('aristada — 662mg, 50 days (no supplementation)', async ({ page }) => {
    ...
    test.skip('haloperidol_decanoate — 4+ doses, 30 days (routine)', async ({ page }) => {
    ...
    test.skip('haloperidol_decanoate — 1-3 doses, 60 days (check-in guidance)', async ({ page }) => {
        await selectField(page, 'medication', 'haloperidol_decanoate');
        await selectField(page, 'guidance-type', 'late');
    ...
    test.skip('fluphenazine_decanoate — 3+ doses, 30 days (routine)', async ({ page }) => {
    ...
    test.skip('fluphenazine_decanoate — 1-2 doses, 90 days (check-in guidance)', async ({ page }) => {
        await selectField(page, 'medication', 'fluphenazine_decanoate');
        await selectField(page, 'guidance-type', 'late');
    ...
    test.skip('uzedy — 150-or-less, 90 days', async ({ page }) => {
    ...
    test.skip('brixadi — monthly-64, 25 days (administer regardless)', async ({ page }) => {
    ...
    test.skip('brixadi — monthly-96, 38 days (fentanyl assessment)', async ({ page }) => {
        await selectField(page, 'medication', 'brixadi');
        await selectField(page, 'guidance-type', 'late');
    ...
    test.skip('sublocade — 100mg, 25 days (administer)', async ({ page }) => {
    ...
    test.skip('sublocade — 300mg-established, 45 days (administer regardless)', async ({ page }) => {
        await selectField(page, 'medication', 'sublocade');
        await selectField(page, 'guidance-type', 'late');
    ...
    test.skip('vivitrol — OUD, 25 days (administer, no UDS)', async ({ page }) => {
    ...
    test.skip('vivitrol — overdose-prevention, 45 days (UDS required)', async ({ page }) => {
        await selectField(page, 'medication', 'vivitrol');
        await selectField(page, 'guidance-type', 'late');
