...
async function selectField(page: Page, id: string, value: string): Promise<void> {
    ...
    if (await radio.count() > 0) {
        // Click the <label> wrapping the hidden radio input. This is what a real
        // user clicks (the visible styled element) and natively fires onchange
        // attribute handlers on all platforms, including Linux CI headless.
